 ...
 */
class xCANJaguar : public MotorSafety, public PIDOutput, public SpeedController, public ErrorBase
{
public:
	...
	explicit xCANJaguar(UINT8 deviceNumber, ControlMode controlMode = kPercentVbus);
	virtual ~xCANJaguar();
...
protected:
	...
	static INT32 receiveMessage(UINT32 *messageID, UINT8 *data, UINT8 *dataSize, float timeout = 0.06);
