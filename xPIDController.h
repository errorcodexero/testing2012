...
#ifndef xPIDCONTROLLER_H_
#define xPIDCONTROLLER_H_
 ...
 * PIDOutput
 */
class xPIDController
{
public:
	xPIDController(float p, float i, float d,
	...
	virtual float GetInput();		// Team 1425 extension
...
private:
	...
	void Calculate();
	DISALLOW_COPY_AND_ASSIGN(xPIDController);
};
